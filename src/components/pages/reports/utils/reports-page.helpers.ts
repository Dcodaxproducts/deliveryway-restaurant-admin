...
export const getReportHeaderContent = (tab: ReportTab, isBranchAdmin: boolean) => {
  ...
  if (tab === "invoice-history") {
    return {
      title: isBranchAdmin ? "Branch Invoice History" : "Invoice History",
      description: isBranchAdmin
        ? "View invoices generated for your assigned branch"
        : "View and download invoices generated by Superadmin",
    };
  }
